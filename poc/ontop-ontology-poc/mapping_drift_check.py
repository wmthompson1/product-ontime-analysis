...
DEFAULT_SHOWCASES = [
    ...
    (
        "capacity planning",
        os.path.join(POC_DIR, "mapping", "capacity_planning.obda"),
        os.path.join(POC_DIR, "ontology", "capacity_planning.ttl"),
    ),
    (
        "shop floor routing",
        os.path.join(POC_DIR, "mapping", "shop_floor_routing.obda"),
        os.path.join(POC_DIR, "ontology", "shop_floor_routing.ttl"),
    ),
    (
        "inventory transactions",
        os.path.join(POC_DIR, "mapping", "inventory_transactions.obda"),
        os.path.join(POC_DIR, "ontology", "inventory_transactions.ttl"),
    ),
    (
        "three-way match",
        os.path.join(POC_DIR, "mapping", "three_way_match.obda"),
        os.path.join(POC_DIR, "ontology", "three_way_match.ttl"),
    ),
]
