...
declare @part_id nvarchar(250) = '417A4182-2'  ---  '401U3500-58688 CFM';  -- '417A4182-2' ; --'BACN11G3A7CD';  -- '70750B-071-MIL-NG';
...
DECLARE  
           ...
           ,@workorder_BASE_ID 	nvarchar(30) = NULL-- '1807646'
...
ORDER BY SITE_ID, PART_ID, TRANSACTION_ID