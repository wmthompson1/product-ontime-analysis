...
-- is meant to be represent material requirements and unissued. but importantly the part id for components can ve the unresolved REWORK MFG,
...
select
  ...
  , reference = ISNULL(r.WORKORDER_BASE_ID,N'') + '/' + SPACE(1) + ISNULL(r.WORKORDER_LOT_ID,N'')  
