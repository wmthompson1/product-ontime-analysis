...
select
  'S1.2.1.1  inventory_trans filter' note
, i.part_id
, i.transaction_id
, i.transaction_date
, i.trace_id
...
, i.warehouse_id
, i.location_id
, i.warehouse_description
, i.issue_reas_id
, i.site_id
, i.effect_on_qty_on_hand
, i.trace_lot
...
, i.act_service_cost
    ...
    , i.trace_unavailable_qty trace_unavailable_qty
...
-- materials requirement flow (subordinate work order link)
  ...
  -- NOTE INNER JOIN MAY EXCLUDE REWORK FLOWS WHERE MATERIAL REQUIREMENT IS LINKED TO PARENT WORK ORDER
...
where 1=1
  ...
  or @Part_ID IS NULL )
  AND (@TRANSACTION_id IS NULL OR i.TRANSACTION_ID = @TRANSACTION_id) -- Filter by specific transaction ID 
  and i.class = 'i' and i.type = 'i'
