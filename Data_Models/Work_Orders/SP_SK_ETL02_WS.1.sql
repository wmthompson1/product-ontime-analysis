...
-- ...\Work Order Reports\WorkOrderDailyStatus\SP_SK_ETL02_WS.1.sql
/****** Object:  StoredProcedure [dbo].[SP_SK_ETL02_WS]    Script Date: 5/5/2026 7:55:53 AM ******/
SET ANSI_NULLS ON
GO
...
SET NOCOUNT ON; 
	...
	DECLARE @in_commodity_code_sand nvarchar(MAX) = N'standards,details';  
...
-- a/
	...
	SELECT a.BASE_ID, a.LOT_ID, a.SPLIT_ID, a.SUB_ID, a.TYPE, a.PART_ID, a.WONUM, a.DESIRED_QTY, a.STATUS, 
		...
		-- ~22
		-- ~23
		--/* query will crash unless top 1 is used - be sure to use top 1 */
