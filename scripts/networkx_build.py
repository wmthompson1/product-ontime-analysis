...
def load_graph():
    ...
    print('🔨 Building NetworkX graph from CSV files...')
    
    G = nx.DiGraph()
    
    # Load nodes
    if not os.path.exists(NODES_CSV):
        print(f'❌ Error: {NODES_CSV} not found. Run "npm run build-graph-node" first.')
        return None
...
def analyze_graph(G):
    ...
    print('')
    print('📊 NetworkX Graph Analytics:')
...
def main():
    print('🐍 Python NetworkX Supply Chain Graph Builder')
    print('')
    ...
    print('')
    print('🎉 NetworkX graph analysis complete!')
    print('')
    print('You can now:')
